(function () {
    ...
    var APP_ICONS = {
        ...
        music:
            '<svg viewBox="0 0 24 24"><defs><linearGradient id="dock-music-bg" x1="0" x2="0" y1="0" y2="1"><stop offset="0" stop-color="#fc5c7d"/><stop offset="1" stop-color="#e02060"/></linearGradient></defs><rect x="2" y="3" width="20" height="18" rx="4.5" fill="url(#dock-music-bg)"/><path d="M11 8.4l6.4-1.4v6.7" fill="none" stroke="#fff" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><circle cx="9.6" cy="14.4" r="1.7" fill="#fff"/><circle cx="16" cy="13.7" r="1.7" fill="#fff"/></svg>',
        terminal:
    ...
    var ITEMS = [
        ...
        { id: "music",      label: "Music",       action: "openMusic",      icon: "music" },
