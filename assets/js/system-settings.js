(function () {
    ...
    function injectCSS() {
        ...
        s.textContent = [
            ...
            ".settings-accents{display:flex;flex-wrap:wrap;align-items:flex-start;gap:14px 18px;padding:0.4em 0 1.4em}",
            ".settings-accent{position:relative;width:22px;border:0;padding:0;cursor:pointer;background:transparent;font:inherit;color:inherit;display:block}",
            ...
            ".settings-accent__label{position:absolute;top:calc(100% + 8px);left:50%;transform:translateX(-50%);font-size:11px;line-height:1;white-space:nowrap;color:rgba(60,60,67,0.85);visibility:hidden;pointer-events:none}",
